...
Arguments:
    <base_directory> - The base directory of a EPMCoin Core source code repository.
...
Arguments:
    <base_directory> - The base directory of EPMCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the EPMCoin Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The EPMCoin
