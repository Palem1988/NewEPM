...
static const int SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT                 = 10007; // epmcoin legacy
static const int SPORK_9_SUPERBLOCKS_ENABLED                            = 10008;
static const int SPORK_10_MASTERNODE_PAY_UPDATED_NODES                  = 10009; // epmcoin legacy
static const int SPORK_12_RECONSIDER_BLOCKS                             = 10011;
static const int SPORK_13_OLD_SUPERBLOCK_FLAG                           = 10012; // epmcoin legacy
static const int SPORK_14_REQUIRE_SENTINEL_FLAG                         = 10013; // epmcoin legacy
...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        // not reuse pubkeys from previous epmcoind run
