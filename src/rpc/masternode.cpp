...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress     - Print the masternode owner EPMCoin address\n"
            "  payee            - Print the masternode payout EPMCoin address (can be additionally filtered,\n"
            "                     partial match)\n"
            "  pubKeyOperator   - Print the masternode operator public key\n"
            "  status           - Print masternode status: ENABLED / POSE_BANNED\n"
            "                     (can be additionally filtered, partial match)\n"
            "  votingaddress    - Print the masternode voting EPMCoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "epmcoin",               "masternode",             &masternode,             true,  {} },
    { "epmcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "epmcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "epmcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
