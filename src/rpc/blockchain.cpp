...
std::string EntryDescriptionString()
{
    return "    \"size\" : n,                 (numeric) transaction size in bytes\n"
           ...
           "       ... ],\n"
           "    \"instantsend\" : true|false, (boolean) True if this transaction was sent as an InstaEPM one\n"
           "    \"instantlock\" : true|false  (boolean) True if this transaction was locked via InstaEPM\n";
}
...
UniValue gettxout(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of epmcoin addresses\n"
...
UniValue getchaintxstats(const JSONRPCRequest& request)
{
    ...
    int blockcount = 30 * 24 * 60 * 60 / Params().GetConsensus().nPosTargetSpacing; // By default: 1 month
