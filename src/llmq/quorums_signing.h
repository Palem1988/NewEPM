...
#ifndef EPMCOIN_QUORUMS_SIGNING_H
#define EPMCOIN_QUORUMS_SIGNING_H
...
public:
    ...
    // This is the case for example when a signature appears as part of InstaEPM or ChainLocks
    ...
    // mechanism prevents possible conflicts. As an example, ChainLocks prevent conflicts in confirmed TXs InstaEPM votes
    void RemoveRecoveredSig(Consensus::LLMQType llmqType, const uint256& id);
