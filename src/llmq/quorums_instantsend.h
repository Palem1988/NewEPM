...
#ifndef EPMCOIN_QUORUMS_INSTANTSEND_H
#define EPMCOIN_QUORUMS_INSTANTSEND_H
...
// SPORK_2_INSTANTSEND_ENABLED generally enables/disables InstaEPM and SPORK_20_INSTANTSEND_LLMQ_BASED switches
...
#endif//EPM_QUORUMS_INSTANTSEND_H
