...
QVariant TransactionTableModel::txInstaEPMDecoration(const TransactionRecord *wtx) const
{
    if (wtx->status.lockedByInstaEPM) {
        QString theme = GUIUtil::getThemeName();
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case RawDecorationRole:
        ...
        case InstaEPM:
            return txInstaEPMDecoration(rec);
        case ToAddress:
    ...
    case Qt::EditRole:
        ...
        case InstaEPM:
            return (rec->status.lockedByInstaEPM ? 1 : 0);
        case ToAddress:
    ...
    case Qt::ForegroundRole:
        ...
        if(rec->status.lockedByInstaEPM)
        {
    ...
    case WatchonlyDecorationRole:
        return txWatchonlyDecoration(rec);
    case InstaEPMRole:
        return rec->status.lockedByInstaEPM;
    case InstaEPMDecorationRole:
        return txInstaEPMDecoration(rec);
...
QVariant TransactionTableModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    if(orientation == Qt::Horizontal)
    {
        ...
        } else if (role == Qt::ToolTipRole)
        {
            ...
            case InstaEPM:
                return tr("Whether or not this transaction was locked by InstaEPM.");
            case ToAddress:
