    ...
    platformStyle(_platformStyle)
{
    ...
    QString windowTitle = tr("Extreme Private Masternode Coin") + " - ";
#ifdef ENABLE_WALLET
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #000000, stop: 1 #333333); border-radius: 7px; margin: 0px; }");
    }
#endif 
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EPMCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and epm: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about EPMCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EPMCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EPMCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a epm: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible EPMCoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EPMCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("EPMCoin"); // default title
