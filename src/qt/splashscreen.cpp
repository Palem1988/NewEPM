    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextEPMCoin   = QChar(0xA9) + QString("2019 ") + QString(tr("The EPMCoin developers"));
    ...
    pixPaint.drawText(paddingLeft, 443, copyrightTextDash);
    pixPaint.drawText(paddingLeft, 455, copyrightTextPac);
    pixPaint.drawText(paddingLeft, 467, copyrightTextEPMCoin);
