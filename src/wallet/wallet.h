...
public:
    ...
    bool IsLockedByInstaEPM() const;
    bool IsLockedByLLMQInstaEPM() const;
...
public:
    ...
    uint64_t nStakeSplitThreshold = 32;
    ...
    /// Get 1000 EPM output and keys which can be used for the Masternode
