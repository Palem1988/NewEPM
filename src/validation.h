...
static const int CONSENSUS_SIGOPABUSE_START = 999999999;
static const int CONSENSUS_SIGOPABUSE_FINISH = 999999999;
 ...
 *  We have 4 times smaller block times in EPMCoin, so we need to push 4 times more invs per 1MB. */
