...
/*
    ...
    one party without compromising the security of InstaEPM
...
/**
 * Manages InstaEPM. Processes lock requests, candidates, and votes.
 */
class CInstantSend
{
public:
...
/**
 * An InstaEPM transaction lock request.
 */
class CTxLockRequest
{
private:
...
/**
 * An InstaEPM transaction lock vote. Sent by a masternode in response to a
...
/**
 * An InstaEPM transaction lock candidate.
 */
class CTxLockCandidate
{
private:
