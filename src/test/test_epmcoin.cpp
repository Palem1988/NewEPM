...
#define BOOST_TEST_MODULE EPMCoin Test Suite

#include "test_epmcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_epmcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
