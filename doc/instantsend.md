...
This mechanism has been integrated into Bitcore-Node-EPMCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/epmcoinpay/insight-api-epmcoin#web-socket-api](https://github.com/epmcoinpay/insight-api-epmcoin#web-socket-api)
* API: [https://github.com/epmcoinpay/insight-api-epmcoin#instantsend-transactions](https://github.com/epmcoinpay/insight-api-epmcoin#instantsend-transactions)
