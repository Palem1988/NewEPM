Cross-compiliation of EPMCoin Core
===============================

EPMCoin Core can be cross-compiled on Linux to all other supported host systems. This is done by changing
the `HOST` parameter when building the dependencies and then specifying another `--prefix` directory when building EPMCoin.
...
When building EPMCoin Core, use
