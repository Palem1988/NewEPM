...
This document provides guidelines for internationalization of the EPMCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `epmcoin_en.ts` remains unchanged.
