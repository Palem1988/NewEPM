...
from test_framework.test_framework import EPMCoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(EPMCoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as EPMCoinTestFramework doesn't support this atm)
